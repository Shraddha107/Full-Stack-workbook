...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e($base); ?>?page=update&id=<?php echo e($Student['id']); ?>" method="POST">
        <label for="name">Name:</label><br>
        <input type="text" name="name" id="name" value="<?php echo e($Student['name']); ?>"><br><br>

        <label for="email">Email:</label><br>
        <input type="email" name="email" id="email" value="<?php echo e($Student['email']); ?>"><br><br>

        <label for="course">Course:</label><br>
        <input type="text" name="course" id="course" value="<?php echo e($Student['course']); ?>"><br><br>
